...
[Defines]
  PLATFORM_NAME                  = Xhyve
  PLATFORM_GUID                  = 98f3e050-a982-45fa-aecb-a07b88c8b6db
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/XhyveX64
  SUPPORTED_ARCHITECTURES        = X64
  BUILD_TARGETS                  = NOOPT|DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = XhyveDarwinPkg/XhyveDarwinPkgX64.fdf
...
!else
  DebugLib|OvmfPkg/Library/PlatformDebugLibIoPort/PlatformDebugLibIoPort.inf
!endif
  PlatformBootManagerLib|XhyveDarwinPkg/Library/PlatformBootManagerLib/PlatformBootManagerLib.inf
